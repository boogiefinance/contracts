...
contract Rave is Ownable {
    ...
    // Sets the unstaking fee. Can't be higher than 50%. _convertToBoogieAmount is the % of the LP tokens from the unstaking fee that will be converted to BOOGIE and distributed to stakers.
